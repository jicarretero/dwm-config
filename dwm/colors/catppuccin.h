...
static const char selbordercolor[] = "#9fac75";
/* static const char selbordercolor[]  = "#a6e3a1"; */
/* static const char col_cyan[] = "#f5c2e7"; */
static const char col_cyan[] = "#9fac75";
static const char krt_grey[] = "#f3f4f5";

static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {krt_grey, col_gray1, col_gray1},
    [SchemeSel] = {krt_grey, col_cyan, selbordercolor},
};
