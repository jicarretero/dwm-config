...
static const char *scratchpadrangercmd[] = {"r", "kitty", "--title", "rangerthing", "-e", "ranger", NULL};
static const char *scratchpadcmuscmd[] = {"m", "kitty", "--title", "musicthing", "-e", "cmus", NULL};
